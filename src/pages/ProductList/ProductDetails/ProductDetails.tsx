        ...
        <div className='bg-white py-4 shadow'>
          <div className='grid grid-cols-12 gap-9'>
            ...
            <div className='col-span-7'>
              ...
              {/* PRODUCT RATING - NUMBER OF RATING AND SELL */}
              <div className='mt-8 flex items-center'>
                <div className='flex items-center'>
                  ...
                  <ProductRating
                    ...
                    nonActiveClassname='fill-orange fill-gray-300 h-4 w-4'
                  />
                </div>
              ...
              <div className='mt-8 flex items-center bg-gray-50 px-5 py-4'>
                ...
                <div className='round-sm bx-1 text- xs ml-4 bg-orange py-[2px] font-semibold uppercase text-white'>
                  Sale {rateSale(product?.price_before_discount, product?.price)}
                </div>
              </div>
