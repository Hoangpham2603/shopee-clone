          ...
          <div className='col-span-1 justify-self-start'>
                ...
                <div className='relative max-w-[400px] rounded-sm border border-gray-200 bg-white text-sm shadow-md'>
                  {purchasesInCart ? (
                    <div className=' p-2'>
                      ...
                      <div className='mt-5'>
                        {purchasesInCart.slice(0, MAXPRODUCTPOPOVER).map((purchase) => (
                      ...
                      <div className='mt-6 flex items-center justify-between'>
                        <div className='text-xs capitalize text-gray-500'>
                          {purchasesInCart.length > MAXPRODUCTPOPOVER ? purchasesInCart.length - MAXPRODUCTPOPOVER : ''}{' '}
                          add to cart
                        </div>
                    ...
                    <div className='flex h-[300px] w-[300px] items-center justify-center p-2'>
                      ...
                      <div className='mt-3'>Nothing in Cart</div>
                    </div>
                  )}
                </div>
              }
            >
              <Link to='/' className='relative'>
                ...
                <span className='absolute right-[-9spx] top-[-5px] rounded-full bg-white px-2 px-[9px] py-[1px] text-xs text-orange'>
